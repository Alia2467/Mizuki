...
class SensorService : Service(), SensorEventListener {
    ...
    private val prefs by lazy { getSharedPreferences("maibot_steps", Context.MODE_PRIVATE) }
            ...
            try {
                ...
                fusedLocationClient.getCurrentLocation(priority, null).addOnSuccessListener { location ->
                    ...
                    executor.execute {
                        ...
                        // GPS 拿不到就用上一次有效位置
                        val effLat = lat ?: lastLat
                        val effLng = lng ?: lastLng
    ...
    companion object {
        ...
        private const val TAG = "MaibotSensor"
